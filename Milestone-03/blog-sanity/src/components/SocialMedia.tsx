...
export default function SocialMedia() {
  return (
    ...
    <nav className="flex gap-2 ">
      <Link href={"https://github.com/Jawad-Chaudhary?tab=repositories"} target="_blank">
      ...
      <Link href={"https://www.linkedin.com/in/muhammad-jawad-ullah-12a679257/"} target="_blank">
